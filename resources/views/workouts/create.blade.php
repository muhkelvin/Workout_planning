...
@section('content')
    <div class="max-w-2xl mx-auto px-4 py-8">
        <div class="bg-white rounded-xl shadow-lg p-6">
            <h1 class="text-3xl font-poppins font-semibold text-[#2D3A4B] mb-6">Create New Workout</h1>
            ...
            <form action="{{ route('workouts.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="comment" id="comment" rows="4"
                              class="w-full border-2 border-[#E8C4C4] rounded-xl p-3 focus:outline-none focus:border-[#6D9B9B] transition-colors placeholder-[#9CA3AF]">{{ old('comment') }}</textarea>
                </div>
